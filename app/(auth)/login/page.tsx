...
export const metadata: Metadata = {
  title: "Login — LeafBuck Console",
  description: "Log in to your LeafBuck account to access your dashboard and earnings.",
};
 ...
 * This is a UI stub. To wire up authentication:
 * 1. Choose an auth provider: Supabase Auth, Clerk, or NextAuth.
 * 2. Convert this to a Client Component ("use client").
 * 3. Replace the form action with the auth provider's sign-in method.
 * 4. On success, redirect to /dashboard using Next.js router.push().
    ...
    <>
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm" style={{ color: "var(--text-muted)" }}>
          Log in to your LeafBuck account
        </p>
      </div>
      ...
      <form className="space-y-5" action="#" method="POST">
        <div>
          <label htmlFor="login-email" className="mb-1.5 block text-sm font-medium" style={{ color: "var(--text-primary)" }}>
            Email address
          </label>
          <input
            id="login-email"
        ...
        <div>
          <div className="mb-1.5 flex items-center justify-between">
            ...
            <a href="#" className="text-xs font-medium text-[#3CB54A] hover:text-[#1E5C28] transition-colors">
              Forgot password?
            </a>
          </div>
          <input
      ...
      <p className="mt-6 text-center text-sm" style={{ color: "var(--text-muted)" }}>
        ...
        <Link href="/signup" className="font-semibold text-[#3CB54A] hover:text-[#1E5C28] transition-colors">
          Sign up free
        </Link>
      </p>
    </>
